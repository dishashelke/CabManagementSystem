...
Notifications
          ...
          <div id="middle">
            ...
            */
                    ...
                    String sql4="select cab_id from CabMaster where date_add(servicing_due_date,interval 5 day)=CURDATE() and available_status=0  and not exists(select cab_id from Maintainance where CabMaster.cab_id=Maintainance.cab_id)";
                    ResultSet rst4=stmt4.executeQuery(sql4);
                    System.out.println(sql4);
                    while(rst4.next())
                    cab_id=rst4.getString(1);
                    if(cab_id==null)
                    {
                        out.println("No Cab recieved from Servicing.......");
                    }
                    else
                    {
                    %>
                    ...
                    <%
                    String sql1="select cab_id from CabMaster where date_add(servicing_due_date,interval 5 day)=CURDATE() and available_status=0  and not exists(select cab_id from Maintainance where CabMaster.cab_id=Maintainance.cab_id)";
                    rst1=stmt2.executeQuery(sql1);
                    while(rst1.next())
                    {
                        System.out.println("Cab Id:"+rst1.getString(1));
                    %>
