...
Notifications
          ...
          <div id="middle">
              <form action="ServicingToDb.jsp" method="Post">
              <h3>CAB FOR SERVICING</h3>
            ...
            String sql = "select cab_id from CabMaster where servicing_due_date <= CURDATE() and available_status = 1";
            ...
            if(cab_id==null)
                {
                    out.println("No Cab For Servicing..........");
                }
            else
            {
            %>
            ...
            <%
            String sql1 = "select cab_id from CabMaster where servicing_due_date <= CURDATE() and available_status = 1";
            ...
            <center><input type=submit value="Send For Servicing">              <a href="Servicing.jsp"><input type="button" value="Back"></a></center>
