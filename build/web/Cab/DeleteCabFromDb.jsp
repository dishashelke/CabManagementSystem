<%-- 
    Document   : DeleteCabFromDb
    Created on : Oct 27, 2010, 11:56:05 PM
    Author     : kjayanta
--%>
...
Notifications
        ...
        <%
            ...
            /*System.out.println("Inside Delete Cab From Db...!");
            int a;
            ...
            */
            ...
            sql = "delete from CabMaster where cab_id = '"+Cab_Id+"'";
            System.out.println("=========="+sql);
            boolean status = stmt.execute(sql);
            if(status)
                {
                    %>
                    Unable To Delete...! Retry...

                    <%
                }
            else{
                %>
                Deleted From DB Successfully...!
                <%
                }
