...
<br><br>
            ...
            String sql = "select distinct m.cab_id, m.cause, m.in_date,e.route_id,e.driver_license_no from Maintainance m, Execution e where m.cab_id = e.cab_id && in_date between '"+start+"' and '"+end+"' group by m.cab_id";
