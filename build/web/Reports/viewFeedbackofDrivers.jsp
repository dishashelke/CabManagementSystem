          ...
          <div id="middle">
			...
			<td>ACTION TAKEN</td>
             ...
             /* System.out.println(request.getParameter("Day"));
              ...
              String sql1="select driver_license_no from DriverMaster";
              ResultSet rst1=stmt1.executeQuery(sql1);
              while(rst1.next())
              {
                  String driver_id=rst1.getString(1);
                  String sql = "select * from Feedback where feedback_from='"+driver_id+"' and feedback_from!='External'";
