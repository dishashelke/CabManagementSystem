<%-- 
    Document   : ShifWiseEmployees
    Created on : Feb 19, 2011, 7:17:17 PM
    Author     : sdisha
--%>
...
Notifications
          ...
          <div id="middle">
              ...
              sql="select count(distinct emp_name)from EmployeeMaster where emp_shift='"+shift+"'";
              rst = stmt.executeQuery(sql);
              /*String total = rst.getI(1);
              out.print(total);             */
              %>
			...
			<td>E-MAIL</td>
              ...
              <%
              sql = "select * from EmployeeMaster where emp_shift='"+shift+ "'";
              rst = stmt.executeQuery(sql);
