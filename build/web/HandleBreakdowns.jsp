...
Notifications
          ...
          <form name="Breakdown" action="AssignNewCab.jsp" method="POST">
          <pre>

        HANDLE CAB BREAKDOWN
...
<%
            ...
            String sql="select cab_id from CurrentCabProgress where breakdown_status = 1 and date(time_current) = current_date";
	...
	Cab Id 	             	<select name="cabid" >
           ...
           <%
            ...
            sql="select cab_id from CurrentCabProgress where breakdown_status = 1";
            rst = stmt.executeQuery(sql);
            while(rst.next())
            {
                cab_id = rst.getString(1);
