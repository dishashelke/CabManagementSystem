...
Notifications
          ...
          <div id="middle">
                    ...
                    <form name="AddCar" action="AddDriverToDb.jsp" method="POST">
          <pre>
 DRIVER  REGISTRATION

      License No          :   <input type="text" name="driver_license_no" value="" size="20" />

      Driver Name         :   <input type="text" name="driver_name" value="" size="20" />

      Driver Address      :
			      <textarea  rows="4" cols="20"  name="driver_address" value=""></textarea>

      Legal Info          :
 			      <textarea name="legal_info" rows="4" cols="20" value=""></textarea>

      Contact No          :   <input type="text" name="driver_contact_no" value="" size="20" />

      Password		  :   <input type="password" name="driver_password" value=""/>


      Shift               :   <input type="radio" name="driver_shift" value="Morning" />  Morning
                              <input type="radio" name="driver_shift" value="Evening" />  Evening
                              <input type="radio" name="driver_shift" value="Night" />  Night

      Driver Joining Date :  <input type="text" name="day" value="" size="2" />   DD   <input type="text" name="month" value="" size="2" />  MM    <input type="text" name="year" value="" size="4" /> YYYY
