...
Notifications
        ...
        function check_v()
        {
           ...
           if(document.UpdateStop.Stop_name.value=="select" )
                {
                    alert("Please select stop name.");
                    document.UpdateStop.Stop_name.focus();
                    return false;
                }
       }
              </script>
 ...
 <form name="UpdateStop" action="UpdateStopFromDb.jsp" method="POST" >
          <pre>
                    Update Stop Details...

         Select Stop Id    <select name="Stop_name" >
        ...
        <%
            ...
            String sql="select stop_name from StopMaster";
            rst = stmt.executeQuery(sql);

            while(rst.next())
            {
                stop_name = rst.getString(1);
                System.out.println("Stop name is "+stop_name);
                %>
