...
Notifications
          ...
          <div id="middle">
              <form action="actionFeedback.jsp" method="Post" onsubmit="return message()"name="feedback">
              <h3>Feedback Of Cab</h3>
              <%-- <table border="1">
                                    <tr>
                                     <th></th>
                                    <th>CAB ID</th>
          ...
          //  String cab_id = request.getParameter("cab_id");
            ...
            rst = stmt.executeQuery(sql2);
             if(!rst.next())
                    {
                        out.println("No Feedback About Any Cab............");
            ...
            while(rst2.next())
            {
                ...
                while(rst1.next())
                {
                     ...
                     if(cab_id.equalsIgnoreCase(feedback_about))
                          {
                            %>
                                    
                                        <tr>
                                            <td><input type="radio" name="user" value="<%=cab_id%>,<%=description%>"></td>
                                        <td><%=cab_id%></td>
