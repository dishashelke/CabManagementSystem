...
Notifications
        ...
        Message sent to Employees...........
           ...
           String sql2 = "select emp_id from Execution where cab_id = '"+cab_id+"' and (select date(alloc_time)) = current_date";
            ...
            String sql="update Exception set exception_status = '1' where description = 'Delay'";
            stmt.executeUpdate(sql);
            String sql1 = "update Exception set action_taken = 'Message Sent' where description = 'Delay'";
