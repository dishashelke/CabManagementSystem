...
Notifications
        ...
        function check_v()
        {
           ...
           if(document.DeleteGuard.guard_id.value=="select" )
                {
                    alert("Please select stop id.");
                    document.DeleteGuard.guard_id.focus();
                    return false;
                }
       }
              </script>
          ...
          <div id="middle">
              ...
              <form action="DeleteGuardFromDb.jsp" method="post" name="DeleteGuard">
                <br/>
             Select Guard Id    <select name="guard_id" >
        ...
        <%
            ...
            String sql="select guard_id from GuardMaster";
            rst = stmt.executeQuery(sql);

            while(rst.next())
            {
                guard_id = rst.getString(1);
                %>
                <option ><%=guard_id%></option>
                <%
            }
            rst.close();
            con.close();
            ...
            <br/>
            <br/>
            <input type="submit" value="Delete" onclick="return check_v()"/><input type="Reset" name="Reset"/>
        </form>
