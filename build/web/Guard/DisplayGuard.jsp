...
<div style="clear:both"></div>
    ...
    <h2>
              ...
              while(rst.next())
              {
                    String guard_id = rst.getString(1);
                    Guard.Display(guard_id);

                    %>
                            <tr>
                            <td><%=Guard.getGuard_name() %></td>
                            <td><%=Guard.getGuard_address() %></td>
                            <td><%=Guard.getGuard_contact_no() %></td>
                            <td><%=Guard.getGuard_shift() %></td>
                        </tr>
