          ...
          <div id="middle">
             ...
             <jsp:useBean id="Guard" class="module2.Guard" scope="request">
              ...
              <%
                        ...
                        String finalgid=null;
                        ConnBean conn = new ConnBean();
                        Connection con = conn.connect();
                        Statement stmt = null;
                        String sql = "select guard_id from GuardMaster order by guard_id desc limit 1";
                                 ...
                                 String temp=gid.toString();
                                   ...
                                   for(int j=0;j<temp.length();j++)
                                   {
                                       if(j==0)
                                           ...
                                           {
                                        gid1=gid1+temp.charAt(j);
                                           }
                                   }
                                   System.out.println("Stop id="+gid1);
                                   newgid=Integer.parseInt(gid1);
                                   newgid++;
                                   String g1=String.valueOf(newgid);

                                   String tg="g";
                                   finalgid=tg.concat(g1);
                           }
                        System.out.println("Final"+finalgid);
                    ...
                    if(Guard.addGuardToDb(finalgid))
                        {
                        %>
                        Guard <%=Guard.getGuard_name()%> Added To DB Successfully...!
                        <%}
                        else{
                            %>
                            Please Try Again...!
                            <br/>
                            <a href="AddGuard.jsp">Go Back...!</a>
                            <%}
                        %>
