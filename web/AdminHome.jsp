  ...
  <body>
    ...
    <li><a href="#"
        ...
        <div id="m2"
            onmouseover="mcancelclosetime()"
            onmouseout="mclosetime()">
        <a href="Driver/AddDriver.jsp">Add</a>
...
<div style="clear:both"></div>
     ...
     <a href="./Reports/Reports.jsp"> View Reports </a>
...
Notifications
          ...
          <div id="right">
              ...
              <pre><jsp:useBean id="Status" class="common.Status" scope="request">
                        <jsp:setProperty name="Status" property="*"/>
<%
Status.CabStatus();
%>        Cab Details

 Allocated Cab       :   <%=Status.getAllotted_cab()%>

 Spare Cab           :   <%=Status.getSpare_cab()%>

 Cabs Send For
 Servicing           :   <%=Status.getServicing_cab()%>

 Cabs Send For
 Maintainance        :   <%=Status.getMaintaince_cab()%>

 Total Cab           :   <%=Status.getTotal_cab()%>
              </pre>
                    <hr/>
                   <pre>
<%
...
%>
 ...
 Allocated Drivers   :  <%=Status.getAllotted_driver()%>

 Total Drivers       :  <%=Status.getTotal_driver()%>
</pre>
                    <hr/>
<%
...
%>
 ...
 Allocated Employees :   <%=Status.getAllotted_employee()%>

 Total Employees     :   <%=Status.getTotal_employee()%>
                   </pre>
                    <hr/>
