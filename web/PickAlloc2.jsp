...
function routeload()
{
    document.forms["FinalExecution"].submit();
        ...
        function check_v()
        {
           ...
           if(document.FinalExecution.cabid.value=="select" )
                {
                    alert("Please select cab.");
                    document.FinalExecution.cabid.focus();
                    return false;
                }

           if(document.FinalExecution.Drivername.value=="select" )
                {
                    alert("Please select driver.");
                    document.FinalExecution.Drivername.focus();
                    return false;
                }

           if(document.FinalExecution.Employeename.value=="select" )
                {
                    alert("Please select employee.");
                    document.FinalExecution.Employeename.focus();
                    return false;
                }
       }
...
%>
          <div id="middle">
                            ...
                            <form name="FinalExecution" action="PickupAddToDb.jsp" method="POST">
          <pre>
              <%
		...
		Select Driver
                ...
                while(rst0.next())
                {
                    System.out.println("Driver is:"+rst0.getString(2));
                %>
                    ...
                    while(rst3.next())
                        {
                            ...
                            System.out.println("Pick up stop is:"+rst4.getString(2));
                            String stop_id=rst3.getString(2);
                            String pickup_stop_id=rst4.getString(2);
                            if(stop_id.equalsIgnoreCase(pickup_stop_id))
                            {
