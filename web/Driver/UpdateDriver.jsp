...
Notifications
          ...
          <div id="middle">
            <form name="UpdateDriver" action="UpdateDriverFromDb.jsp" method="POST">
          <pre>
                    Update Driver Details...

         Select Driver Id    <select name="Driver_name" >
        ...
        <%
            ...
            String sql="select driver_name from DriverMaster";
            rst = stmt.executeQuery(sql);

            while(rst.next())
            {
                driver_name = rst.getString(1);
                System.out.println("Driver name is "+driver_name);
                %>
