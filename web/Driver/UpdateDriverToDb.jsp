...
Notifications
        ...
        String driver_license_no = request.getParameter("driver_license_no");
        String driver_address = request.getParameter("driver_address");
        String driver_contact_no1 = request.getParameter("driver_contact_no");
        long driver_contact_no = new Long(driver_contact_no1);
        char driver_shift = request.getParameter("shift").charAt(0);
        String legal_info = request.getParameter("legal_info");
        String driver_password = request.getParameter("driver_password");
        ...
        Driver.setDriver_address(driver_address);
        Driver.setDriver_license_no(driver_license_no);
        Driver.setDriver_shift(driver_shift);
        Driver.setLegal_info(legal_info);
        Driver.setDriver_password(driver_password);
        Driver.setDriver_contact_no(driver_contact_no);
        %>


        <%
           Driver.updateDriverFromDb(driver_license_no);
        %>
        Driver <%=driver_license_no%> Updated Successfully...!
        </jsp:useBean>
        </jsp:useBean>
