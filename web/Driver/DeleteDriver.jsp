...
Notifications
          ...
          <div id="middle">
                        ...
                        <form name="DelDriver" action="DeleteDriverFromDb.jsp" method="POST">
          <pre>
        Enter Details...

        Select Driver Id    <select name="license_no" >
        ...
        <%
            ...
            while(rst.next())
            {
                ...
                System.out.println("Driver License No "+license_no);
                %>
                <option ><%=license_no%></option>
                <%
            }
            rst.close();
            con.close();
