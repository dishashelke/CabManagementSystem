...
<div style="clear:both"></div>
    ...
    <h2>
			...
			<th>Shift</th>
              ...
              while(rst.next())
              {
                    String driver_license_no = rst.getString(1);
                    Driver.Display(driver_license_no);
                    %>
                            <tr>
                            <td><%=Driver.getDriver_license_no() %></td>
                            <td><%=Driver.getDriver_name() %></td>
                            <td><%=Driver.getDriver_address() %></td>
                            <td><%=Driver.getDriver_contact_no() %></td>
                            <td><%=Driver.getDriver_shift() %></td>
                            <td><%=Driver.getDriver_joining_date() %></td>
                            <td><%=Driver.getLegal_info() %></td>
                        </tr>
