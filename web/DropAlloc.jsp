...
%>
          ...
          <div id="middle">
      		<form name="FinalExecution" action="DropAlloc2.jsp" method="POST">
          <pre>
              <%
              ...
              %>
		Select Shift
				<input type="radio" name="shift" value="Morning" onclick="" checked="checked"/>  Morning
                                <input type="radio" name="shift" value="Evening" onclick="" /> Evening
                                <input type="radio" name="shift" value="Night" onclick=""/>  Night
		Select Route
			...
			<th>SOURCE</th>
              ...
              while(rst1.next())
              {
                    ...
                    %>
                            <tr>
                                <td><input type="radio" name="route" value="<%=rst1.getString(1)%> "/></td>
