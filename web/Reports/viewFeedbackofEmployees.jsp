<%-- 
    Document   : viewFeedbackofEmployees
    Created on : Apr 16, 2011, 10:04:07 AM
    Author     : guest
--%>
...
Notifications
          ...
          <div id="middle">
              ...
              <h3>Feedback Details From Drivers</h3>
			...
			<td>ACTION TAKEN</td>
             ...
             /* System.out.println(request.getParameter("Day"));
              ...
              String sql1="select emp_id from EmployeeMaster";
              ResultSet rst1=stmt1.executeQuery(sql1);
              while(rst1.next())
              {
                  String emp_id=rst1.getString(1);
                  String sql = "select * from Feedback where feedback_from='"+emp_id+"' and feedback_from!='External'";
