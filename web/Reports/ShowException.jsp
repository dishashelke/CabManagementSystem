...
Notifications
          ...
          <div id="middle">
			...
			<td>REMARK</td>
              ...
              String sql = "select * from Exception where exception_time between '"+fromDate+" : 00:00:00' and '"+toDate+ " :00:00:00'";
			...
			<td>20-9-2009</td>
                        ...
                        <td>Accident</td>
			<td>New cab Sent/Legel Action Taken against Driver<br>
				d101.Sachin
			</tr>
