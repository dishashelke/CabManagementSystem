...
Notifications
        ...
        function check_v()
        {
           ...
           if(document.DeleteRoute.route_id.value=="select" )
                {
                    alert("Please select route id.");
                    document.DeleteRoute.route_id.focus();
                    return false;
                }
       }
              </script>
          ...
          <div id="middle">
              ...
              <form action="DeleteRouteFromDb.jsp" method="post" name="DeleteRoute">
                <br/>
             Select Route Id    <select name="route_id" >
