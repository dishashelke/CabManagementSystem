...
Notifications
          ...
          <div id="middle">
              <form action="SendForServicing.jsp" method="Post">
              <h3></h3>
              <br><br>
            ...
            String sql2 = "update CabMaster set available_status = 0 where cab_id = '"+request.getParameter("cab_id")+"'";
            stmt1.executeUpdate(sql2);
            String sql1 = "update CabMaster set servicing_due_date=CURDATE() where cab_id = '"+request.getParameter("cab_id")+"'";
            stmt.executeUpdate(sql1);


            %>
            Cab Id :&nbsp;<%=request.getParameter("cab_id")%>&nbsp; Sent for Servicing<br><br><br>
