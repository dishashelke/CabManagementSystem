...
Notifications
          ...
          <div id="middle">
                    ...
                    <form name="AddCar" action="AddCabToDb.jsp" method="POST">
          <pre>
        Enter Details...

        Enter Cab Id    <input type="text" name="cab_id" value="" />		<span id="result1"></span>

        Description
			<textarea name="desc" rows="4" cols="20" value=""></textarea>


        Purchase Date <input type="text" name="day" value="" size="2" />   DD   <input type="text" name="month" value="" size="2" />  MM    <input type="text" name="year" value="" size="4" /> YYYY
