...
Notifications
          ...
          <div id="middle">
                ...
                <h4>Recieve Cab From Servicing</h4>
                <form action="RecieveFromServicing.jsp" method="post">
           ...
           /* String sql="select date_add(servicing_due_date,interval 5 day),cab_id from CabMaster where available_status=0 and not exists(select cab_id from Maintainance where CabMaster.cab_id=Maintainance.cab_id)";
            ...
            %>
            Cab Id: <%=request.getParameter("cab_id")%>  is ready to use again.

            <%
            String sql1="update CabMaster set servicing_due_date=date_add(servicing_due_date,interval 1 year) where cab_id = '"+request.getParameter("cab_id")+"'";
            stmt1.executeUpdate(sql1);
            try
            {
            String sql2 = "update CabMaster set available_status = 1 where cab_id = '"+request.getParameter("cab_id")+"'";
