...
Notifications
          ...
          <div id="middle">
              ...
              <jsp:useBean id="Stop" class="module2.Stop" scope="request">
                  <jsp:setProperty name="Stop" property="*"/>
              ...
              <%
                        ...
                        Statement stmt = null;
                        String sql = "select stop_id from StopMaster order by stop_id desc limit 1";
                                 ...
                                 String temp=sid.toString();
                                   ...
                                   for(int j=0;j<temp.length();j++)
                                   {
                                       if(j==0)
                                           ...
                                           {
                                        sid1=sid1+temp.charAt(j);
                                           }
                                   }
                                   System.out.println("Stop id="+sid1);
                                   newsid=Integer.parseInt(sid1);
                                   newsid++;
                                   String s1=String.valueOf(newsid);

                                   String ts="s";
                                   finalsid=ts.concat(s1);
                           }
                        System.out.println("Final"+finalsid);
                    if(Stop.addStopToDb(finalsid))
                        {
                        %>
                        Stop <%=Stop.getStop_name()%> Added To DB Successfully...!
                        <%}
                        else{
                            %>
                            Please Try Again...!
                            <br/>
                            <a href="AddStop.jsp">Go Back...!</a>
                            <%}
                        %>
              </jsp:useBean>
              </jsp:useBean>
